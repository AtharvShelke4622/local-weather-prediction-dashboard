...
def print_access_info():
    ...
    print("  Frontend App:    [RUNNING] - http://localhost:5174")
    print()
    
    print("Try these commands:")
    print("  [WEB] Open browser:    http://localhost:5174")
    ...
    print("  1. Register: curl -X POST http://localhost:8000/api/v1/auth/register \\")
...
def start_services():
    ...
    try:
        ...
        print("[OK] Frontend started on http://localhost:5174")
    except Exception as e:
...
async def main():
    ...
    if start_services():
        ...
        try:
            ...
            print("Please manually open http://localhost:5174 in your browser")
